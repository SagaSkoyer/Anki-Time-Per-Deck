...
DEFAULT_OVER_LIMIT_GRACE_PERCENT = 10
DEFAULT_MAX_ANSWER_SECONDS = 60
EXTEND_BATCH = 1
DEFAULT_BACKLOG_FAIL_LIMIT = 1
...
def _apply_for_deck(did: int, *, allow_extend: bool = True) -> int:
    ...
    if state == OVER:
        return _bury_over(did) + _set_target_today_only_new_limit_to_zero(did)
    if state == DONE:
...
class SettingsDialog(QDialog):
    def __init__(self, parent) -> None:
        ...
        self.backlog_suppress_new_cards = QCheckBox("Suppress new cards")
